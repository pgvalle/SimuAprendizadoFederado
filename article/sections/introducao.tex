...
realiza o treinamento localmente com seus próprios dados e,
em vez de enviar os dados brutos para o servidor,
transmite apenas as atualizações do modelo \cite{mcmahan2017communication}.
...
Esse processo, denominado \textit{training round} (rodada de treinamento),
repete-se iterativamente por um determinado número de vezes até a convergência do modelo global \cite{mcmahan2017communication, li2022federated}.
...
Além disso, o FLSC negligencia o fato de que o peso de participação do cliente em cada um dos $N$ clusters pode ser diferente.

Para superar essas limitações, este trabalho propõe o FLASC (\textit{Federated Learning with Adaptive Soft Clustering}).
Diferente do FLSC, o FLASC permite que a quantidade de clusters integrados varie dinamicamente conforme a necessidade de cada cliente.
Além disso, ele propõe uma adaptação mais precisa e robusta à heterogeneidade dos dados ao
ponderar a contribuição de cada modelo de cluster proporcionalmente à sua afinidade local.
